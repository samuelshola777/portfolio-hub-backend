...
public class KeepAliveScheduler {
  ...
  private static final String KEEP_ALIVE_URL =
    "https://portfolio-hub-backend-qgky.onrender.com/api/v1/system/keep-alive";
  ...
  public void getStatus() {
    ...
    log.info(
      "  Last Call: {}",
      lastCallTime != null ? lastCallTime.format(formatter) : "Never"
    );
    log.info(
      "  Next Call: {}",
      nextCallTime != null ? nextCallTime.format(formatter) : "Not scheduled"
    );
